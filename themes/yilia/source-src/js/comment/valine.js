    ...
    function(e, t, n) {
      ...
      r.prototype.init = function(e) {
        ...
        try {
          ...
          n && r && t.installLocale(n, r),
            (t.locale = t.locale || v[e.lang || 'zh-cn']),
            (t.notify = e.notify || !1),
            (t.verify = e.verify || !1)
          var d = l
            ? '&q=' +
              Math.random()
                ...
                .substring(2)
            : ''
          ;(g.params = '?d=' + (i.indexOf(a) > -1 ? a : 'mp') + '&v=' + o + d),
            (g.hide = 'hide' === a),
            (g.cdn = (!!c && c) || g.cdn),
            (x = e.path || x)
          var p = Number(e.pageSize || 10)
          if (
            ((e.pageSize = isNaN(p) ? 10 : p < 1 ? 10 : p),
            s.setOptions({
          ...
          Api.setServer(e.server)
          var y = (e.region || 'cn').toLowerCase(),
            k = ['cn', 'us']
          y = k.indexOf(y) > -1 ? y : k[0]

          for (
            var _ = u.findAll(document, '.valine-comment-count'),
              A = 0,
              O = _.length;
            A < O;
            A++
          ...
          if (!(S = S instanceof HTMLElement ? S : $[$.length - 1] || null))
            return
          ;(t.el = S),
            t.el.classList.add('v'),
            g.hide && t.el.classList.add('hide-avatar'),
            (e.meta = (e.guest_info || e.meta || m).filter(function(e) {
          ...
          ;(t.placeholder = e.placeholder || 'Just Go Go'),
            (t.el.innerHTML =
              ...
              t.placeholder +
              '"></textarea><div class="vctrl"><span class="vemoji-btn">Emoji</span> | <span class="vpreview-btn">Preview</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' +
              t.locale.ctrl.reply +
          ...
          t.nodata = {
            show: function(e) {
              return (
                (C.innerHTML = e || t.locale.tips.sofa),
                u.attr(C, 'style', 'display:block;'),
                t
              )
            },
            hide: function() {
          ...
          t.loading = {
            show: function(e) {
              ...
              return (
                e ? L.insertBefore(M, n[0]) : L.appendChild(M),
                t.nodata.hide(),
                t
              )
            },
            hide: function() {
              ...
              return (
                e && u.remove(L, e),
                0 === u.findAll(L, '.vcard').length && t.nodata.show(),
                t
              )
            }
          }
          ...
          ;(t.alert = {
            show: function(e) {
              ...
              if (
                ...
                u.on('click', u.find(T, '.vcancel'), function(e) {
                  t.alert.hide()
                }),
                u.attr(T, 'style', 'display:block;'),
                e && e.type)
              ) {
      ...
      ;(r.prototype.Q = function(e) {
        if (1 == arguments.length) {
          return Api.queryComment(decodeURI(e))
        }
        var i = '[' + JSON.stringify(arguments[1]).replace(/(\[|\])/g, '') + ']'
        return Api.queryReply(i)
      }),
        ...
        (r.prototype.installLocale = function(e, t) {
          var n = this
          return (
            (t = t || {}), e && ((v[e] = t), (n.locale = v[e] || v['zh-cn'])), n
          )
        }),
        ...
        (r.prototype.bind = function(e) {
          ...
          var m = function(e) {
              ...
              return (
                u.each(n, function(e, n) {
                  1 === n.nodeType &&
                    (r.indexOf(n.nodeName) > -1 &&
                      ('INPUT' === n.nodeName &&
                      'checkbox' === u.attr(n, 'type')
                        ? u.attr(n, 'disabled', 'disabled')
                        : u.remove(t, n)),
                    'A' === n.nodeName && i(n, 'href'),
                    u.clearAttr(n))
                }),
                t.innerHTML
              )
          ...
          var L = function(e, n, r) {
              ...
              if (s) {
                ...
                l =
                  ...
                  '</span>' +
                  ' ' +
                  ('<span class="vsys">' + s.os + ' ' + s.osVersion + '</span>')
              }
              var p = '',
                f = e.link || ''
              ;(p = f
          ...
          var j = function() {
            ...
            P = function(e) {
              ...
              ;(h.mail = n.k ? n.v : ''),
                (h.link = r.k ? r.v : ''),
                t.notify || t.verify ? V(Q) : Q()
            },
            Q = function() {
              u.attr(I, 'disabled', !0), t.loading.show(!0)
              n = {}
              if (
                ((h.url = decodeURI(x)), (h.insertedAt = new Date()), R.rid)
              ) {
                var r = R.pid || R.rid
                ;(n['rid'] = R.rid),
                  (n['pid'] = r),
              ...
              Api.submitComment(n).then(e => {
                ...
                try {
                  if (R.rid) {
                    var i =
                      u.find(t.el, '.vquote[rid="' + R.rid + '"]') || C(R.rid)
                    L(e, i, !0)
                  } else
                    n
                      ? ((r = Number(n.innerText) + 1), (n.innerText = r))
                      : (u.find(t.el, '.vcount').innerHTML =
          ...
          u.on('click', I, P),
            u.on('keydown', document, function(e) {
              ...
              if (
                ((e.ctrlKey || e.metaKey) && 13 === n && P(), 9 === n) &&
      ...
      var k = {
        ...
        link: function(e) {
          return (
            (e = e.length > 0 && (/^https?/.test(e) ? e : 'http://' + e)),
            {
              k: /^https?:\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:\/~\+#]*[\w\-\@?^=%&amp;\/~\+#])?/.test(
                e
              ),
              v: e
            }
